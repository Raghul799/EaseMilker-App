                        ...
                        children: [
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: const [
                                      Text('Manage Account', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                                    ],
                                  ),
                                ),
                                const SizedBox(height: 8),
                                _buildTile(
                                  context,
                                  const Icon(Icons.volume_up_outlined, color: Color(0xFF0B57A7), size: 22),
                                  'Alert Sound',
                                  null,
                                ),
                                _buildTile(
                                  context,
                                  const Icon(Icons.language, color: Color(0xFF0B57A7), size: 22),
                                  'Change Language',
                                  null,
                                ),
                                _buildTile(
                                  context,
                                  const Icon(Icons.lock_outline, color: Color(0xFF0B57A7), size: 22),
                                  'Change password',
                                  null,
                                ),
                                _buildTile(
                                  context,
                                  const Icon(Icons.shopping_cart_outlined, color: Color(0xFF0B57A7), size: 22),
                                  'Shop',
                                  null,
                                ),
                                _buildTile(
                                  context,
                                  const Icon(Icons.event_note_outlined, color: Color(0xFF0B57A7), size: 22),
                                  'My Booking',
                                  null,
                                ),
                              ],
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: const [
                                      Text('Issues and Information', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                                    ],
                                  ),
                                ),
                                const SizedBox(height: 8),
                                _buildTile(
                                  context,
                                  const Icon(Icons.help_outline, color: Color(0xFF0B57A7), size: 22),
                                  'Help & Contact',
                          ...
                          Padding(
                            ...
                            child: OutlinedButton.icon(
                              ...
                              icon: const Icon(Icons.logout, color: Color(0xFF0B57A7)),
                              label: const Padding(
                                padding: EdgeInsets.symmetric(vertical: 12.0),
                                child: Center(
                                  child: Text('LOGOUT', style: TextStyle(color: Color(0xFF0B57A7), fontWeight: FontWeight.w600)),
                                ),
                              ),
                              style: OutlinedButton.styleFrom(
                                side: const BorderSide(color: Color(0xFF0B57A7)),
